  ...
  <div className="centered-content">
    <div className="culinary-container">
      ...
      <p className="culinary-paragraph">
        ...
        in the meticulous process, precision, and artistic choices. Join us in
        celebrating the culinary industry, where passion meets precision.
        Without a dedicated platform, we aim to create a space for chefs to
        share their stories and connect. Let's appreciate the extraordinary
